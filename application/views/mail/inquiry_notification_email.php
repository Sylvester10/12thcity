    ...
    <div id="container" style="width: 100%; height: auto; padding: 10px 10px 10px 10px; background-color:rgb(240, 240, 240); position: relative; border-radius:5px; ">
        ...
        <div id="paymentContainer" style="max-width: 400px; height: auto; background-color: white; margin:auto; position: relative; padding:10px 0px 10px 0px; border-radius:20px; ">
            ...
            <div style="position: relative; width: 80%; margin:auto; text-align: left; color: rgb(90,90,90); margin-top: 10px; margin-bottom: 30px;">
                <p> Inquiry Type: <b style="color:rgb(40,40,40);"><?= $type; ?></b></p>
                <br>
                <p> I am a: <b style="color:rgb(40,40,40);"><?= ucwords(str_replace('-', ' ', $iAmA)); ?></b></p>
                <br>
                <p> First Name: <b style="color:rgb(40,40,40);"><?= $firstName; ?> <?= $lastName; ?></b></p>
                <br>
                <p> Email: <b style="color:rgb(40,40,40);"><?= $email; ?></b></p>
                <br>
                <p> Location: <b style="color:rgb(40,40,40);"><?= $location; ?></b></p>
                <br>
                <p> Property: <b style="color:rgb(40,40,40);"><?= ucwords(str_replace('-', ' ', $property)); ?></b></p>
                <br>
                <p> Max Price: <b style="color:rgb(40,40,40);"><?= $price; ?></b></p>
                <br>
                <p> Minimum Size (Sq ft): <b style="color:rgb(40,40,40);"><?= $size; ?></b></p>
                <br>
                <p> Number of Beds: <b style="color:rgb(40,40,40);"><?= $bedNum; ?></b></p>
                <br>
                <p> Number of Baths: <b style="color:rgb(40,40,40);"><?= $bathNum; ?></b></p>
            </div>
