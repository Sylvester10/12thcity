							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-home"></i> Projects <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="<?php echo base_url('admin-add-project'); ?>">Add Projects</a></li>
									</ul>
								</li>

								<li><a><i class="fa fa-calendar"></i> Events <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="<?php echo base_url('admin-events'); ?>">All Events</a></li>
								...
								<li><a><i class="fa fa-users"></i> Staff <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="<?php echo base_url('admin-staff'); ?>">All Staff</a></li>
										<li><a href="<?php echo base_url('admin-add-staff'); ?>">Add Staff</a></li>
									</ul>
								</li>

								<li><a><i class="fa fa-award"></i> Awards <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="<?php echo base_url('admin-awards'); ?>">All Awards</a></li>
										<li><a href="<?php echo base_url('admin-add-award'); ?>">Add Award</a></li>
									</ul>
								</li>

								<li><a><i class="fa fa-calendar"></i> Gallery <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="<?php echo base_url('admin-gallery'); ?>">All Gallery</a></li>
									</ul>
								</li>
